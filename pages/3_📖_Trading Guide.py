...
st.write("#")
# 
st.image("https://github.com/J1GS4W2487/ChartW/blob/master/Images/MACD.JPG",caption='Tickers', width=500, use_column_width=00, clamp=False, channels="RGB", output_format="auto")
st.write("#")
