...
st.write("#")
# 
st.image("https://drive.google.com/file/d/1TVt8flQWQvdTmT-CatDJv1gqZ14hW76-/view?usp=share_link/",caption='Tickers', width=500, use_column_width=00, clamp=False, channels="RGB", output_format="auto")
st.write("#")
