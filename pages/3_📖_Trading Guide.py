...
st.write("#")
# 
st.image("https://www.pexels.com/photo/landscape-nature-sky-man-6620743/",caption='Tickers', width=500, use_column_width=00, clamp=False, channels="RGB", output_format="auto")
st.write("#")
